...
public class Mg_Controller {
	...
	public String updateItem(@PathVariable("accountCode") String accountCode,
			@RequestParam("accountName") String accountName, @RequestParam("accountNum") String accountNum,
			@RequestParam("accountManager") String accountManager, RedirectAttributes redirectAttributes,
			Principal principal) {
		...
		redirectAttributes.addFlashAttribute("errorMessage", "업데이트 권한이 없습니다.");
		return "redirect:/MG/accmg";
